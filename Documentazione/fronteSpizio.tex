...
\lstinputlisting[caption={"Gestion del login 1"}, firstline={34}, lastline={52}]{../parser.c}
...
\paragraph{}
\lstinputlisting[caption={"Gestion del login 2"}, firstline={53}, lastline={75}]{../parser.c}
