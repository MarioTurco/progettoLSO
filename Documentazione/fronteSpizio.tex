...
\lstinputlisting[caption= {Configurazione indirizzo del server}, firstline={169}, lastline={176}]{../server.c}
\lstinputlisting[caption={Configurazione socket del server}, firstline={451}, lastline={465}]{../server.c}
...
\lstinputlisting[caption={Procedura di ascolto del server}, firstline={131}, lastline={168}]{../server.c}
...
tra client e server.
\lstinputlisting[caption={Prima comunicazione del server}, label={alg:serverPreLogin}, firstline={219}, lastline={244}]{../server.c}
...
\lstinputlisting[caption={Prima comunicazione del client}, firstline={84}, lastline={101}, label={alg:clientPreLogin} ]{../client.c}
\pagebreak
...
\lstinputlisting[caption={Funzione play del server}, label={alg:playServer}, firstline={245}, lastline={319}]{../server.c}
...
\lstinputlisting[caption={Funzione play del client}, label={alg:playclient}, firstline={110}, lastline={148}]{../client.c}
\pagebreak
...
\lstinputlisting[caption={Funzione di gestione del timer}, firstline={416}, lastline={449}]{../server.c}
...
\lstinputlisting[caption={Generazione nuova mappa e posizione players}, firstline={384}, lastline={395}]{../server.c}
...
\lstinputlisting[caption={Funzione di log}, firstline={587}, lastline={618}]{../server.c}
\paragraph{}
...
\lstinputlisting[caption={Funzione spostaPlayer}, firstline={620}, lastline={633}]{../server.c}
