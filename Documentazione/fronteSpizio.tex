...
\lstinputlisting[caption= {Configurazione indirizzo del server}, firstline={171}, lastline={178}]{../server.c}
\lstinputlisting[caption={Configurazione socket del server}, firstline={453}, lastline={467}]{../server.c}
...
\lstinputlisting[caption={Procedura di ascolto del server}, firstline={132}, lastline={170}]{../server.c}
...
tra client e server.
\lstinputlisting[caption={Prima comunicazione del server}, label={alg:serverPreLogin}, firstline={221}, lastline={246}]{../server.c}
...
\lstinputlisting[caption={Funzione play del server}, label={alg:playServer}, firstline={247}, lastline={321}]{../server.c}
...
\lstinputlisting[caption={Funzione di gestione del timer}, firstline={418}, lastline={452}]{../server.c}
...
\lstinputlisting[caption={Generazione nuova mappa e posizione players}, firstline={386}, lastline={397}]{../server.c}
...
\lstinputlisting[caption={Funzione di log}, firstline={589}, lastline={620}]{../server.c}
\paragraph{}
...
\lstinputlisting[caption={Funzione spostaPlayer}, firstline={622}, lastline={635}]{../server.c}
